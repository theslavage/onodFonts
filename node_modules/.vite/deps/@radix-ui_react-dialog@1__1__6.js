...
function createSlot(ownerName) {
  ...
  const Slot22 = React17.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime4.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React17.isValidElement(newElement) ? React17.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime5.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React18.Children.map(children, (child) => (0, import_jsx_runtime5.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime5.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
